...
const modules = [
  { name: "Deal Workbench", href: "/deal-workbench", icon: "briefcase" },
  { name: "Impact Modeler", href: "/impact-modeler", icon: "chart" },
  { name: "Comp Calculator", href: "/comp-calculator", icon: "calculator" },
  { name: "Process Tracker", href: "/process-tracker", icon: "workflow" },
  { name: "Resource Library", href: "/resource-library", icon: "library" },
  { name: "Compliance", href: "/compliance-center", icon: "shield" },
  { name: "Value Overview", href: "/value-overview", icon: "star" },
];
      ...
      <div className="max-w-[1600px] mx-auto px-4">
        <div className="flex items-center h-14">
          ...
          <Link href="/" className="flex items-center gap-2 mr-8 shrink-0">
            ...
            <span className="font-semibold text-lg tracking-wide">JH</span>
          </Link>
